				...
				<table>
					...
					<tr>
						...
						<td><input class="column_date" type="text" id="dateRcvdFrm">
							&nbsp;to <input class="column_date" type="text" id="dateRcvdto">
						</td>
			...
			<div class="report" id="deviceDiv">
				<table>
					...
					<tr>
						...
						<td><select class="column_dropDown" id="devProductProblem"></td>
					</tr>
					<tr>
						<td>Brand Name</td>
					...
					<tr>
						...
						<td><select class="column_dropDown" id="devOperator"></td>
					</tr>
					<tr>
						<td>Product Code</td>
		...
		<div class="inner" id="patInner">
			...
			<div class="report" id="patientDiv">
				<table>
					...
					<tr>
						<td>Outcome</td>
						<td><select class="column_dropDown" id="patOutcome"></td>
					</tr>
